...
const REPORTS = [
  {
    ...
    desc: "Warehouse-only stock ledger, separate from store movements",
    icon: ArrowLeftRight,
  },
  {
    href: "/reports/returns",
    label: "Returned Stock",
    desc: "Returned items, inventory action and refunds paid",
    icon: PackageMinus,
  },
  {
    href: "/reports/stock-take",
    label: "Stock-take Variance",
    desc: "Physical counts and posted stock differences",
    icon: ClipboardList,
  },
  {
    href: "/reports/goods-in",
    label: "Supplier Purchases",
    desc: "Purchases by supplier, date and delivery reference",
    icon: PackagePlus,
  },
  {
    href: "/warehouse",
    label: "Warehouse Stock",
    desc: "Stock held separately in permitted warehouses",
    icon: Boxes,
  },
  {
    href: "/operations/transfers",
    label: "Transfers",
    desc: "Transfer lifecycle and linked location movements",
    icon: ArrowLeftRight,
  },
  {
    href: "/reports/unpacking",
    label: "Unpacking",
    desc: "Bulk conversions, quantities and reasons",
    icon: PackagePlus,
  },
  {
    href: "/reports/price-history",
    label: "Price History",
    desc: "Cost and selling-price changes",
    icon: TrendingUp,
  },
  {
    href: "/reports/profit",
    label: "Gross Profit",
    desc: "Sales less returns and stock cost",
    icon: Wallet,
  },
  {
    href: "/invoices",
    label: "Invoices",
    desc: "Issued, paid and outstanding invoices",
    icon: ClipboardList,
  },
  {
    href: "/reports/ageing",
    label: "Invoice Ageing",
    desc: "Outstanding balances by overdue period",
    icon: CalendarClock,
  },
  {
    href: "/reports/reconciliation",
    label: "Monthly Reconciliation",
    desc: "Invoice ledger totals and cash received",
    icon: Wallet,
  },
  {
    href: "/reports/refunds",
    label: "Refund Report",
    desc: "Approved refunds and payment references",
    icon: PackageMinus,
  },
  {
    href: "/reports/payments",
    label: "Payment Report",
    desc: "Cash, Card/EFT and Credit reconciliation",
    icon: Wallet,
  },
  {
    href: "/reports/stock-valuation",
    label: "Stock Valuation",
    desc: "Current stock value by product",
    icon: Boxes,
  },
  {
    href: "/reports/movements",
    label: "Stock Movements",
    desc: "Full stock ledger with filters",
    icon: ArrowLeftRight,
  },
  {
    href: "/reports/goods-in",
  ...
  {
    href: "/reports/goods-out",
    label: "Goods Out",
    desc: "Cash, Card/EFT and credit sales",
    icon: PackageMinus,
  },
  {
    href: "/reports/adjustments",
    label: "Stock Adjustments",
    desc: "Corrections, damage, losses",
  ...
  },
  {
    href: "/expiry",
    label: "Expiry",
    desc: "Approaching and expired stock",
    icon: CalendarClock,
  },
  {
    href: "/low-stock",
