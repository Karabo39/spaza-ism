...
function ProductRegisterDialogContent({
  open,
  onOpenChange,
  initialBarcode = "",
  initialName = "",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This barcode isn&apos;t in your catalog yet. Add it to continue.
          </DialogDescription>
        </DialogHeader>
...
export function ProductRegisterDialog(
  props: React.ComponentProps<typeof ProductRegisterDialogContent>,
) {
  const { store } = useStore();
  return props.open ? (
    <ProductRegisterDialogContent
      key={store.id + (props.initialBarcode ?? "") + (props.initialName ?? "")}
      {...props}
    />
  ) : null;
}
