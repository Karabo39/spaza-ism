...
try {
  for (const suite of ["document_workflows", "employee_invitations", "batch_expiry_daily_totals", "cash_shifts_barcode", "invoice_refinements", "store_currencies_documents"]) {
