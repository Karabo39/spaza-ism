...
describe("release safeguards", () => {
  it("rejects missing, partial and future-incompatible contracts", () => {
    ...
    expect(matchesRelease({ version: 2, capabilities: { brd_v102: true, module_access_v1: true, cash_up_v1: true, order_workflow_v1: true, document_workflows_v1: true } })).toBe(false);
    expect(matchesRelease({ version: 1, capabilities: { brd_v102: true, module_access_v1: true, cash_up_v1: true, order_workflow_v1: true, document_workflows_v1: true } })).toBe(true);
  });
